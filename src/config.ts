...
export const siteConfig: SiteConfig = {
	...
	lang: "zh_CN", // Language code, e.g. 'zh-CN', 'zh-TW', 'ja', etc.
	themeColor: {
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/FranklinCN", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
	...
	name: "THZ",
	bio: "Unleash your creativity,<br/>software shapes the future.",
	links: [
		{
			name: "Facebook",
		...
		},
		{
			...
			url: "https://steamcommunity.com/id/thz1145/",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/Franklin",
		},
		{
			name: "Bilbili",
